...
SUP_BUTTONS = [
    [
        Button.url("• Github •", url="https://github.com/"),
        Button.url("• Support •", url="t.me/DiegoAkk"),
    ],
    [
...
HELP_BUTTONS = [
    [
        Button.url("• Owner •", url="https://t.me/DiegoAkk"),
        Button.url("• Support •", url="https://t.me/BlacKBullChannel"),
    ],
]
