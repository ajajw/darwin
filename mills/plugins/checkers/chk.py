...
async def _(m, gate_db, user_db, cards, lang):
    ...
    if proxy:= await m.adb.get_key('use_proxy'):
        browser.proxies = {'http://zyerfteb-rotate:u9byqore4j2y@p.webshare.io:80/': 'http://zyerfteb-rotate:u9byqore4j2y@p.webshare.io:80/', 'http://zyerfteb-rotate:u9byqore4j2y@p.webshare.io:80/': 'http://zyerfteb-rotate:u9byqore4j2y@p.webshare.io:80/'}
